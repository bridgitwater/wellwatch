...
<div style="max-width:560px;margin:0 auto;padding:32px 20px">
  ...
  <p style="font-size:12px;color:#8a9ba3">You're receiving this because you funded a well with BridgIT Water Foundation. <a href="${APP_URL}/wells" style="color:#8a9ba3">Manage notifications</a> from your wells page.</p>
</div></body></html>`;
}
